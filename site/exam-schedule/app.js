...
window.addEventListener('exam-schedule:data-change',()=>{state=Model.readState(localStorage,console);renderAll();renderTimeline()});
renderAll();
})();
