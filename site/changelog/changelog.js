  ...
  var SEED = [
    {
      ...
      description: [
        '## 新功能',
        '- 新增记账应用，可记录收支、查看仪表盘与明细，并支持表格导出',
        '- 训练中可跳过当天剩余组数，未完成的训练会在下次打开时继续',
        '## 改进',
        '- 应用内容优先显示，登录状态改为后台校验，打开速度更顺畅',
        '- 统一各应用的返回入口，并修复主页应用网格与底部栏重叠的问题',
        '- 词汇游戏改为直接管理星标，移除未使用的 FSRS 调度与复习历史',
        '- 整理项目结构与同步逻辑，提升后续维护和数据同步的稳定性'
      ].join('\n')
    },
    {
      version: 'v0.5.0',
